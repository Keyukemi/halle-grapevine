        ...
        <div>
            ...
            bg-primary shadow-2xl p-12 mt-12 relative rounded-br-2xl">
                ...
                <div className="w-1/2 flex flex-col items-start justify-between pl-6">
                     <span className="font-medium text-secondary text-xl">{type}</span>
                    ...
                    <div className="mt-2 flex items-center">
                        ...
                        <Link href={link} target="_blank" className="bg-headline ml-4 rounded-lg text-secondary p-2 px-6 text-lg font-semibold">
                            View Project
                        </Link>
                    </div>
                </div>
...
const SPersonalProj = ({type, title, summary, img, link, githubLink}) =>{
    return( 
        <div>
            ...
            bg-primary shadow-2xl p-6 relative">
