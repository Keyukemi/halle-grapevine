    ...
    return( 
        <div>
            ...
            <article className="w-full flex items-center justify-between rounded-3xl border
              border-solid dark:border-black text-headline dark:bg-headline dark:text-primary
            ...
            lg:flex-col lg-p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4 ">
                ...
                bg-headline opacity-50  dark:bg-darkshadow rounded-br-3xl xs:-right-2 sm:w-[100%] sm:h-[102%] xs:rounded-[1.5rem] "/>
                ...
                <div className="w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6  ">
                    ...
                    <div className="mt-2 flex items-center">
                        ...
                        <Link href={link} target="_blank" className="bg-secondary border-2 ml-4 rounded-lg hover:border-2 hover:border-solid hover:border-headline dark:hover:border-primary
                         text-primary hover:text-headline dark:text-headline dark:bg-highlight dark:hover:bg-headline dark:hover:text-primary hover:bg-transparent
    ...
    return( 
        <div>
            <article className="w-full flex flex-col items-center justify-between rounded-2xl border
              border-solid dark:bg-headline dark:border-black dark:text-primary
            bg-primary shadow-2xl p-6 relative text-headline xs:p-4 ">
                <div  className="absolute top-0 -right-3 -z-10 w-[102%] h-[103%]  bg-headline opacity-50 rounded-3xl
                md:-right-2 md:w-[101%] xs:h-[102%] xs:rounded-[1.5rem] dark:bg-darkshadow"/>
                ...
                <div className="w-full flex flex-col items-start justify-between mt-4">
                     ...
                     <Link href={link} target="_blank" className="underline-offset-2">
