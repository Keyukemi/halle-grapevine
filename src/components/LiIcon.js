    ...
    return (
        <figure className="absolute left-0 stroke-headline stroke-2">
            <svg className="-rotate-90 md:w-[60px] md:h-[60px] xs:w-[40px] xs:h-[40px] " width="75" height="75" viewBox="0 0 100 100">
                <circle cx="75" cy="50" r="20" className="stroke-secondary dark:stroke-highlight xs:stroke-2 stroke-1 fill-none dark:fill-headline"/>
                <motion.circle cx="75" cy="50" r="20"  className="stroke-[5px] fill-primary xs:stroke-[10px]" 
                style={
